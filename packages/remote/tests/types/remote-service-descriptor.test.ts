...
const invalidServiceAssignment: typeof validDescriptor = otherDescriptor;
void invalidServiceAssignment;
...
// @ts-expect-error RPC-DESC-001 keeps the selected definition invariant.
const invalidSelectionAssignment: typeof validDescriptor = addOnlyDescriptor;
void invalidSelectionAssignment;

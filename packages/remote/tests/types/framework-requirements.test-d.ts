...
test("RPC-POLICY-004 keeps the internal scheduler private", () => {
	...
	type HandlerJob = import("../../src/modules/peer").RpcHandlerJob;
...
test("RPC-API-005 keeps Publisher roles private and role-specific", () => {
	...
	type ConnectorPublisher =
		import("../../src/modules/owner").IRpcConnectorPublisher;
	...
	type ConnectorPublication =
		import("../../src/modules/owner").RpcConnectorPublication;
	...
	type ConnectorCommit = import("../../src/modules/owner").RpcConnectorCommit;
	...
	type AcceptorPublisher =
		import("../../src/modules/owner").IRpcAcceptorPublisher;

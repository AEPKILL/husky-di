...
This document covers the types and schemas in
`src/types/remote-service-descriptor.type.ts`. The package root is currently
empty; these contracts do not imply a published factory or RPC runtime.

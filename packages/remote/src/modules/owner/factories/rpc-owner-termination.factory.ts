...
} from "@/modules/owner/impls/rpc-owner-termination.impl";
import type { RpcOwnerTerminationFactory } from "@/modules/owner/interfaces/rpc-owner-termination.interface";

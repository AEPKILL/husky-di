...
import type { RpcInterceptor, RpcPeerState } from "@/modules/peer";
import type {
...
import { readRpcAbortSignalAborted } from "@/shared/utils/rpc-cancellation.util";
...
export const rpcConnectorOptionsObjectSchema = z.strictObject({
	...
	interceptor: z
		.custom<RpcInterceptor>((value) => typeof value === "function")
		.optional(),
});

...
import type { RpcApplicationValue } from "@/modules/protocol/interfaces/rpc-protocol.interface";
import type {
	rpcAckRecordSchema,
...
} from "@/modules/protocol/utils/rpc-wire-grammar.util";
...
export type RpcStreamOpenMessage = RpcSchemaOutput<
	typeof rpcStreamOpenMessageSchema
>;
export type RpcStreamNextMessage = RpcSchemaOutput<
	typeof rpcStreamNextMessageSchema
>;
export type RpcStreamCompleteMessage = RpcSchemaOutput<
	typeof rpcStreamCompleteMessageSchema
>;
export type RpcStreamErrorMessage = RpcSchemaOutput<
	typeof rpcStreamErrorMessageSchema
>;
export type RpcStreamCancelMessage = RpcSchemaOutput<
	typeof rpcStreamCancelMessageSchema
>;
export type RpcStreamSemanticMessage =
	| RpcStreamOpenMessage
	| RpcStreamNextMessage

...
import type { RpcCallTerminalTypeEnum } from "@/modules/protocol/enums/rpc-call-terminal-type.enum";
import type { RpcIncomingCallKindEnum } from "@/modules/protocol/enums/rpc-incoming-call-kind.enum";
import type { RpcProtocolSessionTransitionTypeEnum } from "@/modules/protocol/enums/rpc-protocol-session-transition-type.enum";
import type { RpcProtocolRuntimePolicy } from "@/modules/protocol/types/rpc-runtime-policy.type";
...
import type { IRpcRetainedBytesReservation } from "@/shared/interfaces/rpc-retained-bytes-ledger.interface";
...
export interface IRpcProtocolIncomingStream {
	/** Commits the selected terminal and tears down the source; absent code means completion. */

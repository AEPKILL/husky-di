...
import { RpcSessionDuplicateEvidenceImpl } from "@/modules/protocol/impls/rpc-session-duplicate-evidence.impl";
...
import { RpcSessionStreamsImpl } from "@/modules/protocol/impls/rpc-session-streams.impl";
import type {
...
import type { RpcSessionStreamsFactory } from "@/modules/protocol/interfaces/rpc-session-streams.interface";
...
export function createBuiltInRpcSessionFactory(
	...
	return (options): IRpcSession =>
		new RpcSessionImpl(options, {
			...
			createStreams: createRpcSessionStreams,
...
export const createRpcSessionDelivery: RpcSessionDeliveryFactory = (options) =>
	new RpcSessionDeliveryImpl(
		options,
		(evidenceOptions) => new RpcSessionDuplicateEvidenceImpl(evidenceOptions),
	);

export const createRpcSessionShutdown: RpcSessionShutdownFactory = (options) =>
	new RpcSessionShutdownImpl(options);

export const createRpcSessionStreams: RpcSessionStreamsFactory = (options) =>
	new RpcSessionStreamsImpl(options);

...
import { rpcConnectorOptionsObjectSchema } from "@/modules/owner";
import {
	DEFAULT_RPC_CONNECTOR_RECONNECTION_ATTEMPT_TIMEOUT_MS,
	DEFAULT_RPC_CONNECTOR_RECONNECTION_RETRY_DELAYS_MS,
} from "@/modules/reconnection/constants/rpc-connector-reconnection.const";
import type { RpcConnectorReconnectionAttemptFailureStageEnum } from "@/modules/reconnection/enums/rpc-connector-reconnection-attempt-failure-stage.enum";
import type { RpcConnectorReconnectionEventTypeEnum } from "@/modules/reconnection/enums/rpc-connector-reconnection-event-type.enum";
import type { RpcConnectorReconnectionStopReasonEnum } from "@/modules/reconnection/enums/rpc-connector-reconnection-stop-reason.enum";
...
export type CreateRpcReconnectionConnectorOptions = Readonly<
...
export const rpcConnectorReconnectionOptionsObjectSchema =
	rpcConnectorOptionsObjectSchema.extend({

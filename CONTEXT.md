...
- **Recovery Retention**: The configured absolute interval (five minutes by default) for which a lost or fenced Session binding retains calls, replay, and identity evidence. Failed resume attempts do not extend it, and v1 does not pressure-evict retained Sessions to admit fresh work.

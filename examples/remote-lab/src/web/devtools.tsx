...
export function Devtools(
	...
	return (
		<>
			...
			<TabsContent
				value={DevtoolsPanelEnum.owners}
				forceMount
				className="devtools-panel"
				hidden={view.panel !== DevtoolsPanelEnum.owners}
				aria-label="Acceptor / Connector"
			>
				<OwnerPanel {...options} />
			</TabsContent>
			<TabsContent
				value={DevtoolsPanelEnum.e2e}
				forceMount
				className="devtools-panel"
				hidden={view.panel !== DevtoolsPanelEnum.e2e}
				aria-label="E2E"
			>
				<E2ePanel />
			</TabsContent>
